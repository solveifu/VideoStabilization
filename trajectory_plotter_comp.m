function trajectory_plotter_comp(T,T_litvin,T_matsu,mode,legPlace)
...
if (mode==1)
    subplot(3,2,1)
    plot(N,T1_final_x,'r',N,T2_final_x,'b',N,T_acc_x,'k','LineWidth',thickness)
    xlabel('Frame number');
    ylabel('Change');
    legend('Litvin','Matsushita','Original','location',legPlace)
    title('b_{1}, x direction');
    subplot(3,2,2)
    plot(N,T1_final_y,'r',N,T2_final_y,'b',N,T_acc_y,'k','LineWidth',thickness)
    xlabel('Frame number');
    ylabel('Change');
    legend('Litvin','Matsushita','Original','location',legPlace)
    title('b_{2}, y direction');
    subplot(3,2,3)
    plot(N,T1_final_a1,'r',N,T2_final_a1,'b',N,T_acc_a1,'k','LineWidth',thickness)
    xlabel('Frame number');
    ylabel('Change');
    legend('Litvin','Matsushita','Original','location',legPlace)
    title('a_{1}, zoom, rotation');
    subplot(3,2,4)
    plot(N,T1_final_a2,'r',N,T2_final_a2,'b',N,T_acc_a2,'k','LineWidth',thickness)
    xlabel('Frame number');
    ylabel('Change');
    legend('Litvin','Matsushita','Original','location',legPlace)
    title('a_{2}, rotation');
    subplot(3,2,5)
    plot(N,T1_final_a3,'r',N,T2_final_a3,'b',N,T_acc_a3,'k','LineWidth',thickness)
    xlabel('Frame number');
    ylabel('Change');
    legend('Litvin','Matsushita','Original','location',legPlace)
    title('a_{3}, rotation');
    subplot(3,2,6)
    plot(N,T1_final_a4,'r',N,T2_final_a4,'b',N,T_acc_a4,'k','LineWidth',thickness)
    xlabel('Frame number');
    ylabel('Change');
    legend('Litvin','Matsushita','Original','location',legPlace)
    title('a_{4}, zoom, rotation');
elseif (mode==2)
    subplot(1,2,1)
    plot(N,T1_final_x,'r',N,T2_final_x,'b',N,T_acc_x,'k','LineWidth',thickness)
    xlabel('Frame number');
