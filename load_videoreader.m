% Function used to load the video.  Please use this, the function load_mmreader.m
% is for use with old Matlab versions.
function [vid_org,vid] = load_videoreader(path,start_pos,num_frames)
